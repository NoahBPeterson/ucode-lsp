...
export class DataFlowAnalyzer {
  ...
  private getBuiltinReturnType(
    ...
    const builtinReturns: Record<string, UcodeDataType> = {
      ...
      length: createUnionType([UcodeType.INTEGER, UcodeType.NULL]),
      substr: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      split: createUnionType([UcodeType.ARRAY, UcodeType.NULL]),
      join: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      trim: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      ltrim: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      rtrim: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      chr: UcodeType.STRING,
      ord: createUnionType([UcodeType.INTEGER, UcodeType.NULL]),
      uc: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      lc: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      type: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      keys: createArrayType(UcodeType.STRING),
      values: UcodeType.ARRAY,
      push: UcodeType.UNKNOWN,
      pop: UcodeType.UNKNOWN,
      shift: UcodeType.UNKNOWN,
      unshift: UcodeType.UNKNOWN,
      iptoarr: createUnionType([UcodeType.ARRAY, UcodeType.NULL]),
      arrtoip: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      int: UcodeType.INTEGER,
      match: createUnionType([UcodeType.ARRAY, UcodeType.NULL]),
      replace: createUnionType([UcodeType.STRING, UcodeType.NULL]),
      system: UcodeType.INTEGER,
      time: UcodeType.INTEGER,
      sleep: UcodeType.BOOLEAN,
      wildcard: createUnionType([UcodeType.BOOLEAN, UcodeType.NULL]),
