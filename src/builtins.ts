export const builtinFunctions = new Map<string, string>([
    ...
    ['proto', 'Get or set the prototype of an object, resource or array.\n\n**Parameters:**\n- `value` (object): Value whose prototype to read or modify\n- `prototype` (object, optional): New prototype to attach\n\n**Returns:** `object | null` - With one argument, returns the current prototype of `value` (or null if it has none). With two arguments, sets the prototype and returns `value` itself (the object, not the prototype). Raises an exception if the second argument is not a valid prototype.\n\n**Example:**\n```ucode\nlet obj = {};\nlet current_proto = proto(obj);      // get current prototype\nlet same = proto(obj, new_prototype); // set prototype, returns obj\n```'],
